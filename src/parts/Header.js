        ...
        <Fragment>
            <div id="header" className="app-header">
                <div className="navbar-header">
                    <Link to="/home" className="navbar-brand"><span className="navbar-logo"></span>
                        <b>Vacunautas</b></Link>
                ...
                <div className="navbar-nav">
                    <div className="navbar-item navbar-form">
                        <form action="" method="POST" name="search">
                            <div className="form-group">
                                ...
                                <button type="submit" className="btn btn-search"><i className="fa fa-search"></i>
                                </button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div className="navbar-item navbar-user dropdown">
                        <Link to="#" className="navbar-link dropdown-toggle d-flex align-items-center"
                        ...
                        <div className="dropdown-menu dropdown-menu-end me-1">
                            ...
                            <Link to="#" className="dropdown-item"><span
                                className="badge badge-danger float-end">2</span> Inbox</Link>
