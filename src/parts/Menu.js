            ...
            <div className="menu">
                ...
                <div className="menu-item has-sub">
                    ...
                    <div className="menu-submenu">
                        <div className="menu-item"><Link to="#" className="menu-link">
                                <div className="menu-text">Menu 1.1</div>
                        </Link></div>
                        <div className="menu-item"><Link to="#" className="menu-link">
                            <div className="menu-text">Menu 1.2</div>
                        </Link></div>
                        <div className="menu-item"><Link to="#" className="menu-link">
                            <div className="menu-text">Menu 1.3</div>
                        </Link></div>
                    </div>
                </div>
                <div className="menu-item d-flex">
                    <Link to="#" className="app-sidebar-minify-btn ms-auto" data-toggle="app-sidebar-minify">
                        <i className="fa fa-angle-double-left"></i></Link>
                </div>
            </div>
        </Fragment>
    )
